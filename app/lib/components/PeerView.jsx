...
export default class PeerView extends React.Component {
          ...
          <div className={classnames("box", { visible: showInfo })}>
            <If condition={audioProducerId || audioConsumerId}>
              ...
              <If condition={audioProducerId}>
                <p>
                  {"id: "}
                  <span className="copiable" data-tip="Copy audio producer id to clipboard" onClick={() => clipboardCopy(`"${audioProducerId}"`)}>
                    {audioProducerId}
                  </span>
                </p>
              ...
              <If condition={audioConsumerId}>
                <p>
                  {"id: "}
                  <span className="copiable" data-tip="Copy video producer id to clipboard" onClick={() => clipboardCopy(`"${audioConsumerId}"`)}>
                    {audioConsumerId}
                  </span>
                </p>
              ...
              <If condition={audioProducerId && audioScore}>{this._printProducerScore(audioProducerId, audioScore)}</If>

              <If condition={audioConsumerId && audioScore}>{this._printConsumerScore(audioConsumerId, audioScore)}</If>
            </If>
            ...
            <If condition={videoProducerId || videoConsumerId}>
              ...
              <If condition={videoProducerId}>
                <p>
                  {"id: "}
                  <span className="copiable" data-tip="Copy audio consumer id to clipboard" onClick={() => clipboardCopy(`"${videoProducerId}"`)}>
                    {videoProducerId}
                  </span>
                </p>
              ...
              <If condition={videoConsumerId}>
                <p>
                  {"id: "}
                  <span className="copiable" data-tip="Copy video consumer id to clipboard" onClick={() => clipboardCopy(`"${videoConsumerId}"`)}>
                    {videoConsumerId}
                  </span>
                </p>
              ...
              <If condition={!isMe && videoMultiLayer}>
                <p>{`current spatial-temporal layers: ${consumerCurrentSpatialLayer} ${consumerCurrentTemporalLayer}`}</p>
                <p>
                  ...
                  <span
                    ...
                    onClick={(event) => {
                      ...
                      if (consumerPreferredTemporalLayer > 0) {
                        ...
                        if (consumerPreferredSpatialLayer > 0) newPreferredSpatialLayer = consumerPreferredSpatialLayer - 1;
                  ...
                  <span
                    ...
                    onClick={(event) => {
                      ...
                      if (consumerPreferredTemporalLayer < consumerTemporalLayers - 1) {
                        ...
                        if (consumerPreferredSpatialLayer < consumerSpatialLayers - 1) newPreferredSpatialLayer = consumerPreferredSpatialLayer + 1;
              ...
              <If condition={videoProducerId && videoScore}>{this._printProducerScore(videoProducerId, videoScore)}</If>
          ...
          .map(
            (
              ...
              <p key={idx} className="indent">
                <Choose>
                  <When condition={rid !== undefined}>{`rid:${rid}, ssrc:${ssrc}, score:${score}`}</When>
  ...
  _printConsumerScore(id, score) {
    return <p key={id}>{`score:${score.score}, producerScore:${score.producerScore}, producerScores:[${score.producerScores}]`}</p>;
  }
}
